...
// FlowButton component with flowing gradient animation
const FlowButton = ({ 
  children, 
  onClick,
  className = "",
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{
          backgroundPosition: isHovered ? ["0% 50%", "100% 50%", "0% 50%"] : ["0% 50%", "0% 50%"],
        }}
        transition={{
          duration: 2,
          repeat: Infinity,
      ...
      <motion.div
        className="absolute inset-0 bg-[#156d95]"
        animate={{
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:block">
            <FlowButton
              ...
              className="px-[18px] py-[15px] rounded-full text-base whitespace-nowrap"
            >
              Start Free Trial
            </FlowButton>
          </div>
          ...
          >
            <div className="px-6 py-6 space-y-4">
              ...
              <div className="pt-4 border-t border-border">
                <FlowButton
                  onClick={() => handleLinkClick("#contact")}
                  className="w-full px-[18px] py-[15px] rounded-full text-base"
                >
                  Start Free Trial
                </FlowButton>
              </div>
