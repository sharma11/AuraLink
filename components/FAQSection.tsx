...
import { StackFeatureSection } from "./StackFeatureSection"
type FAQItem = {
  question: string
  answer: string
}
...
export const FAQSection = ({ title = "Frequently asked questions", faqs = defaultFAQs }: FAQSectionProps) => {
  ...
  return (
    <section className="relative w-full py-24 px-8 bg-white overflow-hidden">
      {/* Background Orbit Animation - Right Side */}
      <div className="absolute -right-64 top-1/2 -translate-y-1/2 w-[80rem] h-[80rem] pointer-events-none opacity-30">
        <StackFeatureSection />
      </div>
