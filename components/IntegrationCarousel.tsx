      ...
      <div className="max-w-[680px] mx-auto">
        ...
        >
          ...
          >
            <Button
              asChild
              className="relative h-auto min-w-[182px] overflow-hidden rounded-full border-0 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-950 px-5 py-2.5 text-[15px] font-medium text-white shadow-none hover:bg-gradient-to-r hover:from-slate-900 hover:via-slate-800 hover:to-slate-950 hover:opacity-95"
            >
              <a href={buttonHref} className="inline-flex items-center justify-center gap-2">
                <span
                  className="pointer-events-none absolute inset-0 opacity-40 mix-blend-screen animate-noise-bg"
                  aria-hidden
                />
